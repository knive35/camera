package com.infy.camera.web.rest;

import com.infy.camera.CameraApp;
import com.infy.camera.domain.Customer;
import com.infy.camera.repository.CustomerRepository;
import com.infy.camera.service.CustomerService;
import com.infy.camera.web.rest.errors.ExceptionTranslator;
...
import java.util.List;
    import static com.infy.camera.web.rest.TestUtil.mockAuthentication;

import static com.infy.camera.web.rest.TestUtil.createFormattingConversionService;
 ...
 */
@EmbeddedKafka
@SpringBootTest(classes = CameraApp.class)
