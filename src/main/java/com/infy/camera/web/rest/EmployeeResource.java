...
import com.infy.camera.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.infy.camera.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "cameraEmployee";
